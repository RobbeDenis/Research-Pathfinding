...
void App_CombinedSteering::Update(float deltaTime)
{
	...
	//UI
	{
		...
		ImGui::SliderFloat("Seek", &m_pBlendedSteering->m_WeightedBehaviors[0].weight, 0.f, 0.1f, "%.2");
		ImGui::SliderFloat("Wander", &m_pBlendedSteering->m_WeightedBehaviors[1].weight, 0.f, 0.1f, "%.2");
