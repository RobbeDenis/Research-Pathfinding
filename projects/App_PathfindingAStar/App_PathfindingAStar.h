...
private:
	...
	PathfinderType m_PathfinderType = PathfinderType::dijkstra;
	int m_PathfinderIndex = int(PathfinderType::dijkstra);
	...
	vector<Elite::GridTerrainNode*> m_vSearchedNodes;
